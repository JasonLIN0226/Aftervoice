...
export function ArchiveWall({ entries, activeId, onClear }: ArchiveWallProps) {
  ...
  return (
    <motion.aside
      ...
      className="distortion-surface archive-panel relative overflow-hidden rounded-[1.75rem] border border-white/10 bg-black/20 p-5 shadow-[0_24px_80px_rgba(0,0,0,0.35)] xl:translate-y-6"
      translate="no"
    >
